...
-(void)printArgsValue
{
    ...
    NSString *argValue = @"";
    void *argBuf = NULL;
    for (NSUInteger idx = 0; idx < originalBlockSignature.numberOfArguments; idx++) {
        ...
        if (idx>0) {
            argValue = [argValue stringByAppendingString:[blockInvocation argumentDescriptionAtIndex:idx]];
        }
